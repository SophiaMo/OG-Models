...
def get_SS(c1_guess, r_old, params):
    beta, sigma, p, l_ub, b, upsilon, A, alpha, delta, ss_max_iter, ss_tol, xi_ss = params
    abs_ss = 1
    ss_iter = 0
    while abs_ss > ss_tol and ss_iter < ss_max_iter:
        ...
        c1_args = (r_old, w_old, beta, sigma, l_ub, b, upsilon, p, 0.0)
        ...
        nvec = hh.get_n(cvec, sigma, l_ub, b, upsilon, w_old, p)
