...
bvec_guess1 = (S-1,) vector, guess for steady-state bvec (b1, b2)
...
bvec_guess2 = (S-1,) vector, guess for steady-state bvec (b1, b2)
bvec_guess3 = (S-1,) vector, guess for steady-state bvec (b1, b2)
...
------------------------------------------------------------------------
bvec_guess = (S-1,) vector, initial guess for steady-state bvec (b2,b3,...b_S)
f_params   = length 4 tuple, (nvec, A, alpha, delta)
b_cnstr    = (S-1,) Boolean vector, =True if b_s causes negative
             consumption c_s <= 0 or negative aggregate capital stock
             K <= 0
